		...
		<HeritageDetailSection title={labels.title}>
			<div className="theme-content-panel p-6 space-y-4">
				<div className="flex items-center gap-3 mb-4">
					...
					<p className="theme-content-panel-heading font-ui text-xs tracking-wider uppercase">
						{object.audioGuide.narratorLabel[locale]}
					</p>
				</div>

				<div className="space-y-1">
					<p className="theme-content-panel-heading font-ui text-xs tracking-widest uppercase">
						{labels.listen}
					</p>
				...
				<div className="pt-4 border-t theme-content-panel-divider grid grid-cols-1 md:grid-cols-2 gap-4">
					<div>
						<p className="theme-content-panel-heading font-ui text-xs tracking-widest uppercase mb-1">
							{labels.atmosphere}
						</p>
