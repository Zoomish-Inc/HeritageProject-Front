...
export const MOCK_HERITAGE_OBJECTS: HeritageObject[] = [
  {
    ...
    formerName: { ru: "Военное собрание Ферганы", uz: "Farg'ona harbiy yig'ilishi" },
    ...
    address: { ru: "г. Фергана, ул. Мустақиллик, 12", uz: "Farg'ona sh., Mustaqillik ko'ch., 12" },
    yearBuilt: 1878,
    architecturalStyle: {
      ru: "Эклектика, русский имперский классицизм",
      uz: "Eklektika, rus imperial klassitsizmi",
    },
    architect: { ru: "Военный инженер Е. Кохановский", uz: "Harbiy muhandis Ye. Koxanovskiy" },
    shortDescription: {
    ...
    architectureDetails: [
      ...
      {
        title: { ru: "Треугольный фронтон", uz: "Uch burchakli fronton" },
        description: {
    ...
    historicalFigures: [
      {
        ...
        role: { ru: "Генерал, первый военный губернатор Ферганской области", uz: "General, Farg'ona viloyatining birinchi harbiy gubernatori" },
        bio: {
        ...
        milestones: [
          { year: 1877, event: { ru: "Назначен военным губернатором Ферганской области", uz: "Farg'ona viloyatining harbiy gubernatori etib tayinlandi" } },
          { year: 1878, event: { ru: "Заложил план нового города Новый Маргилан", uz: "Yangi Marg'ilon shahrining yangi rejasini tuzdi" } },
          { year: 1882, event: { ru: "Скончался во время военного похода", uz: "Harbiy yurish paytida vafot etdi" } },
        ],
      },
    ],
    photos: [
      { url: "https://upload.wikimedia.org/wikipedia/commons/thumb/2/2c/Fergana_oblast_building.jpg/800px-Fergana_oblast_building.jpg", caption: { ru: "Здание военного собрания, начало XX в.", uz: "Harbiy yig'ilish binosi, XX asr boshlari" }, isHistorical: false },
    ],
    beforeAfterPairs: [],
    audioGuide: {
      narratorLabel: { ru: "Историк Рустам Назаров", uz: "Tarixchi Rustam Nazarov" },
      transcript: {
    ...
    coverImageUrl: "https://upload.wikimedia.org/wikipedia/commons/thumb/8/8a/Fergana_-_old_city.jpg/1200px-Fergana_-_old_city.jpg",
    visualStyleNotes: {
  ...
  },
  {
    ...
    order: 2,
    name: { ru: "Здание военного губернатора", uz: "Harbiy gubernator binosi" },
    formerName: { ru: "Резиденция военного губернатора Ферганской области", uz: "Farg'ona viloyati harbiy gubernatori rezidentsiyasi" },
    currentPurpose: { ru: "Административное здание (Хокимият г. Фергана)", uz: "Ma'muriy bino (Farg'ona shahri hokimiyati)" },
    historicalPurpose: {
    ...
    address: { ru: "г. Фергана, пл. Мустақиллик, 1", uz: "Farg'ona sh., Mustaqillik maydoni, 1" },
    yearBuilt: 1879,
    yearRange: "1879–1899",
    architecturalStyle: {
    ...
    architect: { ru: "Инженер-архитектор А. Бенуа (предположительно)", uz: "Muhandis-me'mor A. Benua (taxminan)" },
    shortDescription: {
    ...
    architectureDetails: [
      {
        title: { ru: "Ионическая колоннада портика", uz: "Portik ion ustunlar qatori" },
        description: {
    ...
    beforeAfterPairs: [],
    audioGuide: {
      narratorLabel: { ru: "Историк Наргиза Юсупова", uz: "Tarixchi Nargiza Yusupova" },
      transcript: {
  ...
  },
  {
    ...
    order: 3,
    name: { ru: "Здание женской гимназии (Дом культуры №1)", uz: "Qizlar gimnaziyasi binosi (№1 Madaniyat uyi)" },
    formerName: { ru: "Женская гимназия Ферганы", uz: "Farg'ona qizlar gimnaziyasi" },
    currentPurpose: { ru: "Городской дом культуры №1", uz: "Shahar madaniyat uyi №1" },
    historicalPurpose: { ru: "Среднее учебное заведение для девочек", uz: "Qizlar uchun o'rta ta'lim muassasasi" },
    address: { ru: "г. Фергана, ул. Навои, 34", uz: "Farg'ona sh., Navoiy ko'ch., 34" },
    yearBuilt: 1890,
    architecturalStyle: { ru: "Кирпичный романтизм, эклектика", uz: "G'isht romantizmi, eklektika" },
    architect: { ru: "Неизвестен / архивные данные уточняются", uz: "Noma'lum / arxiv ma'lumotlari aniqlanmoqda" },
    shortDescription: {
    ...
    beforeAfterPairs: [],
    audioGuide: {
      narratorLabel: { ru: "Историк Камола Рашидова", uz: "Tarixchi Kamola Rashidova" },
      transcript: {
    ...
    coverImageUrl: "https://upload.wikimedia.org/wikipedia/commons/thumb/5/5e/Fergana_school_historical.jpg/1200px-Fergana_school_historical.jpg",
  },
  {
    id: "4",
    slug: "chasovnya-aleksandra-nevskogo",
    order: 4,
    name: { ru: "Часовня Святого Александра Невского", uz: "Muqaddas Aleksandr Nevskiy ibodatxonasi" },
    currentPurpose: { ru: "Часовня (действующая)", uz: "Ibodatxona (faol)" },
    historicalPurpose: { ru: "Православная часовня в память о погибших воинах", uz: "Halok bo'lgan jangchilar xotirasiga pravoslav ibodatxonasi" },
    address: { ru: "г. Фергана, ул. Ататюрк, 5 (территория городского парка)", uz: "Farg'ona sh., Atatürk ko'ch., 5 (shahar parki hududi)" },
    yearBuilt: 1892,
    architecturalStyle: { ru: "Русско-византийский стиль", uz: "Rus-Vizantiya uslubi" },
    architect: { ru: "Военный инженер (имя не установлено)", uz: "Harbiy muhandis (ismi aniqlanmagan)" },
    shortDescription: {
    ...
    architectureDetails: [
      ...
      {
        title: { ru: "Кокошники и узорочье", uz: "Kokoshniklar va naqshinkorlik" },
        description: {
    ...
    beforeAfterPairs: [],
    audioGuide: {
      narratorLabel: { ru: "Историк Антон Великанов", uz: "Tarixchi Anton Velikanov" },
      transcript: {
    ...
    coverImageUrl: "https://upload.wikimedia.org/wikipedia/commons/thumb/a/a9/Russian_Orthodox_chapel_Central_Asia.jpg/800px-Russian_Orthodox_chapel_Central_Asia.jpg",
  },
  {
    id: "5",
    slug: "khram-sergiya-radonezhskogo",
    order: 5,
    name: { ru: "Храм Сергия Радонежского", uz: "Sergiy Radonezhskiy ibodatxonasi" },
    currentPurpose: { ru: "Православный храм (действующий)", uz: "Pravoslav ibodatxonasi (faol)" },
    historicalPurpose: { ru: "Православная церковь Ферганского гарнизона", uz: "Farg'ona garnizoni pravoslav cherkovi" },
    address: { ru: "г. Фергана, ул. Пушкина, 17", uz: "Farg'ona sh., Pushkin ko'ch., 17" },
    yearBuilt: 1897,
    architecturalStyle: { ru: "Псевдорусский стиль, русский церковный историзм", uz: "Psevdorus uslubi, rus cherkov istorizmi" },
    ...
    architectureDetails: [
      {
        title: { ru: "Крестово-купольная композиция", uz: "Xoch-gumbaz kompozitsiyasi" },
        description: {
    ...
    historicalFigures: [
      {
        ...
        role: { ru: "Православный святой, небесный покровитель храма", uz: "Pravoslav avliyosi, ibodatxonaning osmon homiysi" },
        bio: {
        ...
        milestones: [
          { year: 1337, event: { ru: "Основал монастырь у горы Маковец", uz: "Makovets tog'i yonida monastir asos soldi" } },
          { year: 1380, event: { ru: "Благословил Дмитрия Донского перед Куликовской битвой", uz: "Kulikovo jangi oldidan Dmitriy Donskoyni duo qildi" } },
          { year: 1422, event: { ru: "Канонизирован Русской православной церковью", uz: "Rus pravoslav cherkovi tomonidan avliyo qilib e'lon qilindi" } },
        ],
      },
    ],
    photos: [],
    beforeAfterPairs: [],
    audioGuide: {
      narratorLabel: { ru: "Настоятель протоиерей Николай", uz: "Ustoz protoierey Nikolay" },
      transcript: {
    ...
    coverImageUrl: "https://upload.wikimedia.org/wikipedia/commons/thumb/c/c4/Russian_church_Fergana.jpg/1200px-Russian_church_Fergana.jpg",
  },
  {
    id: "6",
    slug: "muzhskaya-gimnaziya",
    order: 6,
    name: { ru: "Здание мужской гимназии", uz: "Erkaklar gimnaziyasi binosi" },
    currentPurpose: { ru: "Средняя общеобразовательная школа №1", uz: "1-sonli o'rta umumta'lim maktabi" },
    historicalPurpose: { ru: "Мужская классическая гимназия", uz: "Erkaklar klassik gimnaziyasi" },
    address: { ru: "г. Фергана, ул. Навои, 18", uz: "Farg'ona sh., Navoiy ko'ch., 18" },
    yearBuilt: 1902,
    architecturalStyle: { ru: "Поздняя эклектика, элементы модерна", uz: "Kech eklektika, modern elementlari" },
    architect: { ru: "Областной архитектор Г.М. Сварика", uz: "Viloyat me'mori G.M. Svarika" },
    shortDescription: {
    ...
    architectureDetails: [
      {
        title: { ru: "Элементы стиля модерн в декоре", uz: "Bezakdagi modern uslubi elementlari" },
        description: {
    ...
    beforeAfterPairs: [],
    audioGuide: {
      narratorLabel: { ru: "Краевед Тимур Хамидов", uz: "O'lkashunos Timur Xamidov" },
      transcript: {
    ...
    coverImageUrl: "https://upload.wikimedia.org/wikipedia/commons/thumb/6/65/Fergana_gymnasium_historical.jpg/1200px-Fergana_gymnasium_historical.jpg",
  },
];

export const MOCK_HERITAGE_LIST: HeritageListItem[] = MOCK_HERITAGE_OBJECTS.map((obj) => ({
  id: obj.id,
  slug: obj.slug,
  name: obj.name,
