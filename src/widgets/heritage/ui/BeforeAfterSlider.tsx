...
import { trackBeforeAfterInteract } from '@/shared/lib/analytics';
import {
...
export const BeforeAfterSlider = ({
	...
	const trackInteraction = useCallback(
		(source: 'drag' | 'range') => {
			...
			trackBeforeAfterInteract(pairLabel, source);
		},
		[pairLabel]
	);
	...
	const onPointerDown = (e: ReactPointerEvent) => {
		...
		setFromClientXThrottled(e.clientX);
